...
public class RPG_Game {
    ...
    public static void start() {
        ...
        Wither wither = new Wither(250, 0, "Ведьма");
        Avrora avrora = new Avrora(220, 15, "Крыса");
        Druid druid = new Druid(230, 15, "Копируйшийся нинзя");
        Antman antman = new Antman(250, 20, "Посейдон");
